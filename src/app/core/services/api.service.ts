...
export class ApiService {
  ...
  public putMultipart(path: string, body: object = {}): Observable<any> {
    this.httpOptions = {
        headers: new HttpHeaders({
            'Authorization': 'Bearer ' + token
        })
    ...
    return this.httpClient
        .put(BASE_URL + path, body, this.httpOptions)
        .pipe(catchError(this.formatErrors));
  }
  ...
  public postMultipart(path: string, body: object = {}): Observable<any> {
    this.httpOptions = {
        headers: new HttpHeaders({
            'Authorization': 'Bearer ' + token
        })
    ...
    return this.httpClient
        .post(BASE_URL + path, body, this.httpOptions)
        .pipe(catchError(this.formatErrors));
  }
